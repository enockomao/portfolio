...
<head>
  ...
  <title>
    Enock Omao | A Geospatial and Remote Sensing analyst based in Nairobi, Kenya.
  </title>
    ...
    <div class="header__text-box row">
      <div class="header__text">
        <h1 class="heading-primary">
          ...
          <span>Enock Omao</span>
        </h1>
        <!-- Put a small paragraph about yourself -->
        <p>A Geospatial and Remote Sensing analyst based in Nairobi, Kenya.</p>
      ...
      <div class="row">
        ...
        <div class="about__content">
          <div class="about__text">
            ...
            <p>
				I am a passionate GIS professional with an ongoing Master's in GIS and Remote Sensing. I have over four years of hands
				on experience in managing spatial data, designing digital maps, and providing technical support. Proficient in 
				programming languages and adept at analyzing complex spatial data. I have a bias in utilizing Machine learning 
				algorithms in Remote sensing and Agriculture.
            </p>
            <!-- Provide a link to your resume -->
            <a href="#" class="btn">Omao Enock Resume/Omao Enock CV 11-03-2026.pdf</a>
          </div>

          <div class="about__photo-container">
            <!-- Add a nice photo of yourself -->
            <img class="about__photo" src=".images/WhatsApp Image 2026-03-13 at 09.35.44.jpeg" alt="" />
          </div>
        </div>
      </div>
    </section>
  ...
  <section class="contact" id="contact">
    <div class="row">
      ...
      <div class="contact__info">
        <p>
          Are you looking for professional support in GIS, Remote Sensing, 
          or spatial data analysis? Do you need help with mapping, 
          geospatial data visualization, satellite image analysis
          Whether you have a project, need consultation, want to ask questions, share ideas.
          feel free to reach out. I’m always open to discussing collaborations, research opportunities.
        </p>
        <!-- Replace the email with yours -->
        <a href="omaoenoch@gmail.com" class="btn">you@example.com</a>
      </div>
    </div>
  </section>
    ...
    <div class="row">
      ...
      <ul class="footer__social-links">
        <li class="footer__social-link-item">
          <a href="https://github.com/enockomao/" title="Link to Github Profile">
            <img src="./images/github.svg" class="footer__social-image" alt="Github">
          </a>
        </li>
        <li class="footer__social-link-item">
          <a href=https://www.linkedin.com/in/enock-omao-8228b422b/">
